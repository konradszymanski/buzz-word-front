...
async function getState() {
    ...
    state = await submit('GET', `https://buzz-word-knd.herokuapp.com/api/state`)
...
function joinGame(room) {
    ...
    submit('POST', `https://buzz-word-knd.herokuapp.com/api/room`, roomInfo)
...
async function signUp() {
    ...
    let result = await submit('POST', `https://buzz-word-knd.herokuapp.com/signup/`, userinfo)
    console.log(result)
}
...
async function signIn() {
    ...
    let userinfo = { username: user.value, password: password.value }
    let result = await submit('POST', `https://buzz-word-knd.herokuapp.com/login/`, userinfo)
    console.log(result)
}
...
async function submitWord() {
    let response = await submit('POST', 'https://buzz-word-knd.herokuapp.com/api/dict', { "letters": letters })
...
async function submit(method, url, requestBodyObj) {
    ...
    // const response = await fetch("https://buzz-word-knd.herokuapp.com/login", {
    //     method: "POST",
